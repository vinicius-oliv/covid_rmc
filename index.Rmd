...
ifelse(Dia == "01", Dia <- "1o", ifelse(as.integer(Dia)<10, Dia <- paste0("0",dia), Dia <- Dia))
...
url <- "https://g1.globo.com/sp/campinas-regiao/noticia/2020/05/01/coronavirus-prefeituras-da-regiao-de-campinas-confirmam-novos-casos-nesta-quinta-1-de-maio.ghtml"
