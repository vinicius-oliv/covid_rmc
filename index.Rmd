...
if(as.numeric(Dia) < 10){
  Dia <- as.character(as.numeric(Dia))
}
...
url <- "https://g1.globo.com/sp/campinas-regiao/noticia/2020/05/06/coronavirus-prefeituras-da-regiao-de-campinas-confirmam-novos-casos-nesta-terca-5-de-maio.ghtml"
