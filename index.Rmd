...
url <- paste0("https://g1.globo.com/sp/campinas-regiao/noticia/2020/", mes, "/", dia, "/coronavirus-prefeituras-da-regiao-de-campinas-atualizam-novos-casos-nesta-",dia_ext,"-",Dia,"-de-",Mes,".ghtml")
...
n<- ggplot(data = totalData, aes(x = Data, y = Total)) +
  ...
  scale_y_continuous(breaks=seq(0, max(totalData$Total) + ceiling(max(totalData$Total)/10), ceiling(max(totalData$Total)/10)),
